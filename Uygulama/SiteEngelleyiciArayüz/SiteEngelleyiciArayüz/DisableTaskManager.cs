...
{
    public partial class DisableTaskManager : Form
    {
        ...
        public DisableTaskManager()
        {
            InitializeComponent();
            InitializeTimer();
        }

        private void DisableTaskManager_Load(object sender, EventArgs e)
        {
            settings.RequestEventD += HandleForm4Request;

            EndProcess("powershell");
        }

        private bool CaYaDTM = false;

        private void HandleForm4Request(object sender, EventArgs e)
        {
        ...
        private void DisableTaskManager_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (CaYaDTM == false)
            {
                e.Cancel = true;
